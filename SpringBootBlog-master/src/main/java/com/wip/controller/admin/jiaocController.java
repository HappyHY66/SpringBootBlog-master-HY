...
@Api("教程管理")
@Controller
@RequestMapping("/admin/jiaoc")
public class jiaocController extends BaseController {

    private static final Logger LOGGER = LoggerFactory.getLogger(jiaocController.class);
